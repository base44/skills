...
| `base44 auth social-login <provider> <enable\|disable>` | Enable or disable social login (google, microsoft, facebook, apple) with optional custom OAuth | [auth-social-login.md](references/auth-social-login.md) |
