...
You must run `npx base44@latestconnectors push` locally to complete authorization for new connectors.
...
| Problem | Solution |
|---------|----------|
| Authorization timed out | Re-run `npx base44@latestconnectors push` and complete OAuth faster |
